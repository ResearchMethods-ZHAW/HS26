...
#Vorschlag wids ersetzten von partiellen Regressions plot durch partielle effect plots

```{r}

library(ggeffects)
plot(wt_effect, show_data = TRUE)
...
margin = "empirical" (deafult): "non-focal" numerische prädiktoren werden gemittelt 
