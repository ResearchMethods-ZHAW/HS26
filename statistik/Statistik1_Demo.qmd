...
blume <- data.frame("cultivar" = cultivar, "size" = c(a, b) ) 
```
...
# Zweiseitig "Test auf Andro ≠ Bullie" (default)
...
t.test(a, b, alternative = "greater",  data = blume)

# Einseitig "Test auf Andro < Bulli"
t.test(size ~ cultivar, alternative = "less",  data = blume) 
t.test(a, b, alternative = "less",  data = blume) 
```
...
Gepaarter t-Test: erster Wert von Andro wird mit erstem Wert von Bullie gepaart, zweiter Wert von Andro mit zweitem von Bullie ect.
